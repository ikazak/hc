                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Patient Analysis by Month</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="m-t-10">
                                    <h4 class="card-title">Patient Feedback By Type</h4>
                                    <h2 class="mt-3">349</h2>
                                </div>
                                ...
                                <ul class="widget-line-list m-b-15">
                                    <li class="border-right">92% <br><span class="text-success"><i
                                                class="ti-hand-point-up"></i>Outpatient</span></li>
                                    <li>8% <br><span class="text-danger"><i
                                                class="ti-hand-point-down"></i>Inpatient</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
